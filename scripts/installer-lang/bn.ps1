...
╚═══════════════════════════════════╝"
    ...
    Spicetify       = "স্পাইসটিফাই সনাক্ত করা হয়েছে"
    NoRestore       = "স্পটএক্স ইতোমধ্যে ইনস্টল করা আছে, কিন্তু xpui.js.bak এবং xpui.css.bak পুনরুদ্ধার করার ফাইলটি খুঁজে পাওয়া যায় নি। `nদয়া করে স্পটিফাই এর ব্যবহারকারী সংস্করণটি আনইন্সটল করুন এবং Install.bat ফাইলটি আবার রান করুন"
    ExpSpotify      = "পরীক্ষামূলক ফিচারসমূহ স্পটিফাই দ্বারা পরিচালিত"
    ExpStandart     = "পরীক্ষামূলক ফিচারসমূহ অন্তর্ভুক্ত করা হয় নি"
    NoRestore2      = "স্পটিফাই ইতোমধ্যে ইনস্টল করা আছে, xpui.bak ফাইলটি খুঁজে পাওয়া যায় নি। `nদয়া করে স্পটিফাই এর ব্যবহারকারী সংস্করণটি আনইন্সটল করুন এবং Install.bat ফাইলটি আবার রান করুন"
    UpdateBlocked   = "স্পটিফাই হালনাগাদ ইতোমধ্যে ব্লক করা হয়েছে"
    UpdateError     = "আপডেট ব্লক করতে ব্যর্থ হয়েছে"
    NoSpotifyExe    = "Spotify.exe খুঁজে পাওয়া যায় নি"
