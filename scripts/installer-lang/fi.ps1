...
╚════════════════════════════════╝"
    ...
    Spicetify       = "Spicetify havaittu"
    NoRestore       = "SpotX on jo asennettu, mutta tiedostot xpui.js.bak- ja xpui.css.bak ei löytynyt. `nAsenna spotify uudelleen ja suorita Install.bat tiedosto uudelleen"
    ...
    NoRestore2      = "SpotX on jo asennettu, xpui.bak tiedostoa ei löynyt. `nAsenna spotify uudelleen ja suorita Install.bat tiedosto uudelleen"
    UpdateBlocked   = "Spotify-päivitykset on jo estetty"
    UpdateError     = "Päivitysten estäminen epäonnistui"
    NoSpotifyExe    = "Spotify.exe tiedostoa ei löytynyt"
