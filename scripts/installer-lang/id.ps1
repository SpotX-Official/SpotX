[PSCustomObject]@{
    ...
    NewV3           = "Apakah anda ingin melanjutkan dengan versi {0} (Memungkinkan terjadinya kesalahan)? [Y/T]"
    Recom           = "Apakah anda ingin memasang versi {0} yang disarankan? [Y/T]"
    ...
    CacheSelect     = "Ingin mengatur pembersihan cache otomatis? [Y/T]"
    ...
    NoRestore2      = "SpotX sudah terinstal, xpui.bak tidak ditemukan. Harap hapus instalan klien Spotify dan jalankan Install.bat lagi"
