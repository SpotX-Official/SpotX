...
╚══════════════════════════════╝"
    ...
    NewV2           = "Your Spotify version ({0}) has not been tested. The stable version for SpotFreedom is {1}"
    ...
    Spicetify       = "Spicetify detected, it should be installed after SpotFreedom. Open the install section in the README? [Y/N]"
    NoRestore       = "SpotFreedom has already been installed, xpui.bak not found. `nPlease uninstall the Spotify client and run Install.bat again"
